...
class MLColor {
  static const Color mlBlue = Color(0xFF336AFF);
  static const Color mlTodayColor = Color(0xFF0053FF);
  static const Color mlTimeSelectedColor = Color(0xFF80A8FF);

  static const Color mlWhite = Color(0xFDF9FCFF);

  static const Color mlHolidayColor = Color(0xffbe0000);
